        ...
        <>
            ...
            <div className="flex  w-full">
                <div className="w-1/6 bg-base-300 border-r-2 border-gray-600  min-h-screen  ">
                    ...
                    <NavLink to={"/seller-profile"} className={({isActive})=> isActive ? "btn w-full hover:bg-amber-800 text-white bg-orange-800" : "btn w-full hover:bg-amber-800 text-white bg-orange-500" }>Seller Profile </NavLink>
                    <NavLink to={"/store-setting"} className={({isActive})=> isActive ? "btn w-full hover:bg-amber-800 text-white bg-orange-800" : "btn w-full hover:bg-amber-800 text-white bg-orange-500" }>Store Settings</NavLink>
                    ...
                    <NavLink to={"/admin-profile"} className={({isActive})=> isActive ? "btn w-full hover:bg-amber-800 text-white bg-orange-800" : "btn w-full hover:bg-amber-800 text-white bg-orange-500" }>Admin Profile</NavLink>
                </div>
