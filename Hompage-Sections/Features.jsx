...
const Features = () => {
    return (
            <div className="grid grid-cols-1 md:grid-cols-2  px-3 md:px-4 lg:px-6 xl:px-10 2xl:px-14 3xl:px-20 p-12 bg-pink-50  justify-items-center lg:grid-cols-3 gap-10">
